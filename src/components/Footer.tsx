      ...
      <div className="container mx-auto max-w-6xl">
          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 bg-defender-blue-800 rounded-lg flex items-center justify-center hover:bg-defender-blue-700 transition-colors">
        ...
        <div className="border-t border-defender-blue-800 mt-12 pt-8 text-center">
          <p className="text-defender-blue-200">
            © 2024 Mobile Defender. All rights reserved. | Made with ❤️ for Bangladesh
          </p>
        </div>
      </div>
    </footer>
